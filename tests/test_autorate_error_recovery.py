...
def mock_config(mock_autorate_config):
    """Alias shared autorate config as mock_config for this module's tests.

    All test methods in this file reference 'mock_config' extensively
    (both as fixture parameter and local variable name after unpacking
    from controller_with_mocks tuples). Using an alias fixture avoids
    renaming hundreds of references while still delegating to the shared
    config.
    """
