"""Configuration validation functions for autorate and steering configs.

Contains all validator functions that check YAML configuration files
for schema errors, unknown keys, cross-field conflicts, and deprecated
parameters. Also defines the valid config path registries.
"""
