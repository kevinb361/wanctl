...
MAX_HISTORY_SAMPLES = 480             # Maximum samples in history (2 minutes at 0.25s intervals)
ASSESSMENT_INTERVAL_SECONDS = 0.25    # Time between assessments (daemon cycle interval)
