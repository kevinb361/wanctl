...
class _FpingDriverThread:
    """Adapt FpingThread to the BackgroundRTTThread protocol."""
...
class RttBackendHandle:
    ...
    def make_thread(
        ...
        *,
        ...
        path deliberately ignores that value and uses the independent
        ``measurement.fping.cadence_sec`` resolved at factory time; otherwise the
        50 ms controller loop's 0.25 s background cadence would permanently trip
        fping's timeout-vs-cadence guard.
        """
