...
- v1.52 Phase 237 Plan 03 extends the standalone Silicom deploy path to install `silicom-test`, its scenario files, and the Phase 213 capture helpers under `/usr/local/libexec/wanctl/`; tests pin artifact ownership and docs now cover the harness deploy path, live gates, and result layout.
