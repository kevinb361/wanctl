...
- v1.42 Phase 201 Plan 201-05 is wiring WANController-level DOCSIS mode telemetry and health fields. WANController now pins restart-required DOCSIS keys, presence-based setpoint plumbing, and per-WAN `self.logger` INFO emission before the health-field implementation lands.
