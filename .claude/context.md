...
- v1.52 Phase 237 Plan 01 begins the HIL harness closeout with Wave-0 scaffolds only: `scripts/phase237-safe16-boundary-check.sh` is a read-only SAFE-16 evidence tool anchored to `v1.51`, and `tests/test_silicom_test_harness.py` now pins HARN-01..05 as RED until `scripts/silicom-test` lands in Plan 02.
