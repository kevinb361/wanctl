...
- **Exporter drift reconciliation:** Both cake-autorate state bridges were deployed from `d6069e87` in separately approved ATT-then-Spectrum transactions with exact rollback and health/history/qdisc/rate proof. The exporter remains intentionally drifted pending a separate exact-hash rollout: repository exporter `cd1be851e7e9fd3c7acb83e1e68dd6907daeb279ceea6b49fb9351483d76dc29` and unit `e64368e0ab0e6d41185d4b589cea075b22c0eabdd9f11241835ed8b275a702cc` do not match the last proven deployed revisions. Do not ship these artifacts as a side effect of an unrelated external-mode deploy, and do not claim the binding/JSON-isolation/YELLOW-state repairs are live until a separately approved exporter-only rollout passes.
