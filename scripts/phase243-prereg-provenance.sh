...
THRESHOLDS_PATH="scripts/phase243-thresholds.json"

usage() {
    cat <<'EOF'
Usage:
  scripts/phase243-prereg-provenance.sh record
  scripts/phase243-prereg-provenance.sh assert-descends <prereg_commit> <evidence_commit>
  scripts/phase243-prereg-provenance.sh assert-blob-unchanged <expected_blob_sha>
EOF
}
