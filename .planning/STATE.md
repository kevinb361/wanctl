...
status: active
stopped_at: REQ-004 ATT policy-path diagnosis gate
last_updated: "2026-07-17T16:23:35-05:00"
last_activity: "v1.61 Work-VPN canary failed endpoint reachability over to_ATT and completed staged rollback to baseline; DNS/endpoints recovered; reapply blocked pending route-path diagnosis"
---
...
- **Live checkpoint — REQ-006:** staged rollback is now live-proven, but the requirement remains OPEN because Work-VPN reachability failed and no controlled bulk-load/tin-counter proof ran. Reapply is blocked pending diagnosis of the current ATT policy-route path plus fresh review/approval. REQ-003 retirement remains blocked.
