...
- [x] **SOAK-02**: Rollback to native `wanctl@{wan}` verified — exercised on one WAN (operator-approved) or trivially provable via documented, preflighted procedure with evidence captured
