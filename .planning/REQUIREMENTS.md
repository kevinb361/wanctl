...
- [ ] **TOOL-01** — `scripts/soak_summary_aggregate.py` aggregator closes CALIB-03 transition-cycle obligation: aggregator output schema stable across v1.43→v1.44 transition; legacy regression test retired in same commit (T17a).
