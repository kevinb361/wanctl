...
- [x] **TOPO-05** — Rollback criteria documented in machine-readable form (`PHASE-205-ROLLBACK-GATES.md` or equivalent): regression >5% on RRUL p99 latency OR Spectrum daemon restart-rate increase OR pressure-state transition-rate increase per hour. Predeploy gate script enforces; Phase 206 gap-closure re-verification is `status: verified` in `206-VERIFICATION.md`.
