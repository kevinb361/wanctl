...
- [x] **DSCP-03**: If marks do not survive to CAKE ingress, the operator gets an early-exit verdict ("diffserv4 remains classification theater — v1.44 confirmed") that short-circuits the A/B as unnecessary; if they do survive, the A/B proceeds.
