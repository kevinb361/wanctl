...
- [ ] **CAKE-02**: Detection reads queue type params from router via REST API (`GET /rest/queue/type`)
- [ ] **CAKE-03**: Detection compares link-independent params (flowmode, nat, ack-filter, wash, diffserv) against known-optimal defaults
- [ ] **CAKE-04**: Detection compares link-dependent params (overhead, RTT) against values specified in YAML config
