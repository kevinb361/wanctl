...
- [ ] **BOOT-01**: All 4 bridge NICs have ethtool optimizations persisted and applied at boot before wanctl starts
- [ ] **BOOT-02**: NIC tuning oneshot is idempotent, logs what was applied, and fails gracefully if a NIC is missing
