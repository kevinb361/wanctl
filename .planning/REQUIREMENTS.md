...
- [ ] **RTOPT-01**: SFP+ interface uses multi-queue-ethernet-default queue type, eliminating TX queue drops during traffic bursts
- [ ] **RTOPT-02**: Switch IRQ processing redistributed to reduce peak core utilization (cpu2 currently 30-46% while cpu1 at 5-9%)
- [ ] **RTOPT-04**: WireGuard TX errors (821K over 2 weeks) diagnosed with root cause identified and fix applied
