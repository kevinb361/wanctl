...
| 201-07-T2 | 07 | 4 | VALN-06 | T-201-29,33 | deploy.sh invokes gate before rsync | shell-syntax + grep | `bash -n scripts/deploy.sh && grep -q 'phase201-predeploy-gate.sh' scripts/deploy.sh` | scripts/deploy.sh | ⬜ pending |
