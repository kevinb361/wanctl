...
- Deprecated field handling (floor_mbps legacy)
  ...
  <verify>Create mental checklist of: documented bounds match code, all validator functions have corresponding doc sections, no undocumented required fields</verify>
