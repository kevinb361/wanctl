...
| REQ-004 | QoS-independent, new-connection steering eligibility | **OPEN** | The approved Work-VPN canary applied the explicit composite producer/consumer, but a new endpoint TCP/443 connection timed out over `to_ATT`; staged rollback returned RouterOS to baseline. See `../infra-ansible/artifacts/network-changes/20260717_routeros-qos-composite-policy/live-canary-result.txt`. The disabled broad `QOS_HIGH` route remains live and disabled. |
