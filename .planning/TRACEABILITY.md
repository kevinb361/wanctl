...
| REQ-003 | Symmetric four-class enforcement and safe duplicate retirement | **OPEN** | Generic RTP, WireGuard, and SSH are active, audit-proven, and natural-traffic-proven. SSH is authoritative #15 before the broad TCP/22 QOS_MEDIUM producer, stable at hash `72d16f5d...c2cb8`, and recorded `4` natural packets / `224` bytes. Evidence: `../infra-ansible/artifacts/network-changes/20260717_routeros-qos-composite-policy/live-canary-result-ssh-20260718T155557Z.md`. UDP 3480 and NNTP remain open; no bridge classifier was removed. |
