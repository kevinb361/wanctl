...
| REQ-003 | Symmetric four-class enforcement and safe duplicate retirement | **OPEN** | Generic RTP is active/audit-/traffic-proven. WireGuard is active/audit-proven at #37 before catch-all #38, stable at hash `862700a2...7293`, generic RTP preserved, wanctl `25/25`, DNS healthy. Zero immediate WireGuard counters are expected because the tunnel is offsite-only; future natural observation is non-blocking. Evidence: `../infra-ansible/artifacts/network-changes/20260717_routeros-qos-composite-policy/live-canary-result-wireguard-20260718T135914Z.md`. SSH, UDP 3480, and NNTP remain open; no bridge classifier was removed. |
...
**Summary:** REQ-001, REQ-002, REQ-004, REQ-005, and REQ-006 PROVEN; REQ-003 OPEN; SAFE-24 PROVEN. Generic RTP is live and traffic-proven; WireGuard is live and mechanically proven. Duplicate bridge-classifier retirement remains gated on the three remaining application-equivalence gaps; WireGuard natural observation is non-blocking and deferred until offsite use.
