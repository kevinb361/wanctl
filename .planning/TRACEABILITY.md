...
| REQ-003 | Symmetric four-class enforcement and safe duplicate retirement | **OPEN** | Generic RTP is active and mechanically proven: hash `39f11729...0d83`, enabled #36 before catch-all #37, explicit corrected-audit PASS, stable status, natural traffic `110` packets / `10,428` bytes, wanctl `25/25`, and DNS healthy. Evidence: `../infra-ansible/artifacts/network-changes/20260717_routeros-qos-composite-policy/live-canary-result-generic-rtp-reapply-20260718T134346Z.md` and `../infra-ansible/artifacts/network-changes/20260717_routeros-qos-composite-policy/generic-rtp-natural-counter-proof-20260718T135025Z.md`; verifier commit `21187c3`. WireGuard, SSH, UDP 3480, and NNTP remain open; no bridge classifier was removed. |
...
**Summary:** REQ-001, REQ-002, REQ-004, REQ-005, and REQ-006 PROVEN; REQ-003 OPEN; SAFE-24 PROVEN. DNS-safe adaptive Work-VPN steering and corrected generic-RTP classification are live, traffic-proven, and verified. Duplicate bridge-classifier retirement remains gated on the four remaining application-equivalence gaps.
