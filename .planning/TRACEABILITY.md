...
| REQ-003 | Symmetric four-class enforcement and safe duplicate retirement | **OPEN** | Operationally blocked: exact live coverage is absent for generic RTP `16384-32767`, WireGuard `51820`, SSH class, UDP `3480`, and NNTP `119`. The direct-SSH add-time `place-before` generic-RTP canary was independently observed after the terminal default and rolled back exactly; see `../infra-ansible/artifacts/network-changes/20260717_routeros-qos-composite-policy/live-canary-result-generic-rtp-20260718T123334Z.md`. No bridge classifier was removed. Further live attempts require redesign and fresh approval. |
...
**Summary:** REQ-001, REQ-002, REQ-004, REQ-005, and REQ-006 PROVEN; REQ-003 OPEN and operationally blocked; SAFE-24 PROVEN. DNS-safe adaptive Work-VPN steering is live and rollback-proven; duplicate bridge-classifier retirement remains blocked on the five application-equivalence gaps and the failed effective-order insertion path.
