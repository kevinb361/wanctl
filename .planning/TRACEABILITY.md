...
| REQ-003 | Symmetric four-class enforcement and safe duplicate retirement | **OPEN** | Generic RTP is active and mechanically proven: selector hash `39f11729...0d83`, enabled #36 immediately before true catch-all #37, explicit corrected-audit PASS, stable independent status, wanctl `25/25`, and DNS healthy. Evidence: `../infra-ansible/artifacts/network-changes/20260717_routeros-qos-composite-policy/live-canary-result-generic-rtp-reapply-20260718T134346Z.md`; verifier commit `21187c3`. Traffic/counter proof plus WireGuard, SSH, UDP 3480, and NNTP remain open; no bridge classifier was removed. |
...
**Summary:** REQ-001, REQ-002, REQ-004, REQ-005, and REQ-006 PROVEN; REQ-003 OPEN; SAFE-24 PROVEN. DNS-safe adaptive Work-VPN steering and corrected generic-RTP classification are live and verified. Duplicate bridge-classifier retirement remains gated on traffic/counter proof and the four remaining application-equivalence gaps.
