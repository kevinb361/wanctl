...
| REQ-003 | Symmetric four-class enforcement and safe duplicate retirement | **OPEN** | Generic RTP and WireGuard are active/audit-/traffic-proven. WireGuard is #37 before catch-all #38, stable at hash `862700a2...7293`, and recorded `1` natural packet / `60` bytes after actual offsite-tunnel use. Evidence: `../infra-ansible/artifacts/network-changes/20260717_routeros-qos-composite-policy/live-canary-result-wireguard-20260718T135914Z.md` and `../infra-ansible/artifacts/network-changes/20260717_routeros-qos-composite-policy/wireguard-natural-counter-proof-20260718T151235Z.md`. SSH, UDP 3480, and NNTP remain open; no bridge classifier was removed. |
