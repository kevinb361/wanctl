...
- [x] **Phase 44.1: Codebase Health & Coverage Recovery** - Fix test pollution, recover 90%+ coverage, update stale docs
...
- [x] 45-01-PLAN.md - Steering daemon shutdown parity (router close, state save, MetricsWriter)
- [x] 45-02-PLAN.md - Shutdown timeout safety (bounded cleanup, per-step timeouts)
...
| 44.1 Codebase Health & Coverage    | 1/1            | Complete | 2026-03-06 |
| 45. Graceful Shutdown              | 2/2            | Complete | 2026-03-06 |
| 46. Contract Tests                 | 0/?            | Deferred | -          |
