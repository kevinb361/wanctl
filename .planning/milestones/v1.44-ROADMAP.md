...
- [x] **Phase 209: Spectrum config migration, production canary, and docs** — Spectrum YAML flips to `920Mbit besteffort wash`, two-snapshot rollback ritual canary, docs updated, SAFE-08 / SAFE-09 mechanical closeout. (completed 2026-05-22)
...
**Plans:** 4/4 plans complete
- [x] 209-01-PLAN.md — Wash readback validation (build_cake_params always-emit-wash + build_expected_readback pass-through + _VALIDATE_KEY_TO_TCA wash + backend hard-fail per D-17) (SAFE-09)
- [x] 209-02-PLAN.md — scripts/check-safe07-source-diff.sh --att-config-whitelist mode + pytest harness (SAFE-08)
- [x] 209-03-PLAN.md — docs/BRIDGE_QOS.md (new) + CONFIGURATION.md allow_wash entry + CHANGELOG.md v1.44.0 heading flip (TOPO-07)
- [x] 209-04-PLAN.md — Spectrum YAML flip + version bump 1.44.0 + two-snapshot canary + 24h A/B soak vs 20260509T183037Z + SAFE-08/09 mechanical closeout (TOPO-03, TOPO-06, SAFE-08, SAFE-09)
...
| 209 — Spectrum config migration + canary + docs | 4/4 | Complete    | 2026-05-23 |
