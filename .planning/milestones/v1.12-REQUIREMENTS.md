# Requirements Archive: v1.12 Deployment & Code Health
...
- [x] **DPLY-01**: Dockerfile installs all runtime dependencies from pyproject.toml (icmplib, requests, paramiko, tabulate, cryptography)
- [x] **DPLY-02**: deploy_refactored.sh installs all runtime dependencies matching pyproject.toml
- [x] **DPLY-03**: install.sh VERSION matches pyproject.toml version
- [x] **DPLY-04**: pyproject.toml version updated to 1.12.0
...
| ----------- | -------- | -------- |
| DPLY-01     | Phase 62 | Complete |
| DPLY-02     | Phase 62 | Complete |
| DPLY-03     | Phase 62 | Complete |
| DPLY-04     | Phase 62 | Complete |
