...
2. HTML coverage report viewable in browser (htmlcov/index.html)
3. CI fails if coverage drops below configured threshold
4. README.md displays current coverage percentage via badge

**Plans**: TBD (determined during plan-phase)
...
3. High-complexity functions (>15 McCabe) identified and documented
...
| COV-03 | 27 | HTML coverage report in htmlcov/ |
| COV-04 | 27 | Coverage threshold enforcement |
...
*Created: 2026-01-24*
*Milestone: v1.5 Quality & Hygiene*
