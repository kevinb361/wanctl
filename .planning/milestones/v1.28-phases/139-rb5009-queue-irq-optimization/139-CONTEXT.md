...
### Router Access
- MikroTik REST API: `https://10.10.99.1/rest/` (admin:***REMOVED-CREDENTIAL***)
...
### Reusable Assets
- MikroTik REST API pattern used extensively in this session: `curl -sk -u admin:***REMOVED-CREDENTIAL*** "https://10.10.99.1/rest/..."` 
