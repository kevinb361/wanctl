...
- [x] 217-02-PLAN.md — Live Spectrum capture: transient `--profile --debug` systemd drop-in, ≥1h window + driven RRUL/upload segment, revert+verify, retrieve raw log (non-autonomous; live production host)
