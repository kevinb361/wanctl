...
- [x] **Phase 137: cake-shaper vCPU Expansion** - Add 3rd vCPU to cake-shaper VM on odin, verify operational (completed 2026-04-04, manual Proxmox task)
- [x] **Phase 138: cake-shaper IRQ & Kernel Tuning** - NIC IRQ affinity balancing + kernel network sysctl optimization (completed 2026-04-04)
- [x] **Phase 139: RB5009 Queue & IRQ Optimization** - SFP+ multi-queue + switch IRQ redistribution (completed 2026-04-04)
- [x] **Phase 140: WireGuard Error Investigation** - Diagnose 821K tx-errors, identify root cause, apply fix (completed 2026-04-05)
...
Plans:
- [x] 138-01-PLAN.md — Update NIC tuning script with 3-core IRQ distribution + sysctl.d drop-in, deploy and verify
...
Plans:
- [x] 139-01-PLAN.md — Apply SFP+ multi-queue + switch IRQ reassignment via REST API, verify
...
Plans:
- [x] 140-01-PLAN.md — Baseline capture + live tunnel diagnosis and fix via REST API
