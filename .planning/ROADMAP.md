...
- [ ] 136-01-PLAN.md -- Windowed suppression counter + health endpoint fields + periodic congestion logging
- [ ] 136-02-PLAN.md -- hysteresis_suppression alert via AlertEngine + SIGUSR1 threshold reload
...
| 136. Hysteresis Observability  | 0/2            | Not started | -          |
