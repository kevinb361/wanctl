...
**Plans**: 3/3 complete (203-01 soak capture script + projection test; 203-02 soak-summary aggregator + replay fixtures; 203-03 docs + SAFE-07 verification)
...
- [ ] 204-01-predeploy-gate-and-deploy-1-PLAN.md — Bump version to 1.43.0 and deploy METRIC-01 + OBSV-05 binary on cake-shaper via Plan 201-15 two-snapshot rollback ritual
...
| 204. CALIB — D-14 Successor Recalibration | 0/6 | Planned | - |
