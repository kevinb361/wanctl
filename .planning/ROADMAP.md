...
**Plans:** 5 plans
- [ ] 207-01-PLAN.md — HRDN-01: fail-closed source-diff verifier (scripts/check-safe07-source-diff.sh dirty-tree pre-check) + pytest coverage
- [ ] 207-02-PLAN.md — HRDN-02: soak-capture transient-failure tolerance (scripts/soak-capture.sh bounded counters + sidecar TSV) + pytest coverage
- [ ] 207-03-PLAN.md — HRDN-03: legacy gate cleanup (atomic 5-site sweep: aggregator + 2 test files + docs + CHANGELOG)
- [ ] 207-04-PLAN.md — HRDN-04: CALIB-02 YAML-promotion NO decision (CHANGELOG entry only; JSON file byte-identical)
...
| 207 — Soak / harness hardening | 0/5 | Not started | - |
