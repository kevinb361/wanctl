...
- [x] 226-01-PLAN.md — Baseline evidence capture: 3-run flent RRUL + per-tin counters/spread on `920/18 besteffort wash` (AB-02) [Wave 1]

**Wave 3** *(blocked on Wave 2 completion)*

- [x] 226-03-PLAN.md — GATE-01 threshold lock: `phase226-thresholds.json` pre-registered accept/rollback gates (GATE-01) [Wave 1]
...
| 227. Candidate diffserv4-wash Deploy + Matched Capture | 1/4 | In Progress|  |
